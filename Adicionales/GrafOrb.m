...
Z=zeros(size(X));
plot3(Pos(1,:),Pos(2,:),Pos(3,:),'LineWidth',2,'Color','r')

set(gca,'DataAspectRatio',[1,1,1]);
hold on
plot3([0,Pos(1,:)],[0,Pos(2,:)],[0,Pos(3,:)]);
Ecli=mesh(X,Y,Z, 'FaceColor',[0.85,0.7,1],'LineStyle','none');
set(Ecli,'EdgeAlpha',0.5,'FaceAlpha',0.5, 'FaceColor',[0.85,0.7,1]);
set(gca,'Color','k')
